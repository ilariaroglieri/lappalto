<?php
	...
	function photoswipe_scripts() {
	  wp_enqueue_style( 'photoswipe', get_stylesheet_directory_uri() . '/assets/js/photoswipe/photoswipe.css');
	  wp_enqueue_script( 'photoswipe', get_stylesheet_directory_uri() . '/assets/js/photoswipe/photoswipe.umd.min.js', array(), NULL, true );
	  wp_enqueue_script( 'photoswipe-lb', get_stylesheet_directory_uri() . '/assets/js/photoswipe/photoswipe-lightbox.umd.min.js', array(), NULL, true );
	}
